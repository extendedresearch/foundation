 ...
 * constant's own name — `RANVIER_ERR_TIMEOUT`, `CA3_ERR_TRUNCATED` — so it is a
 * value the specification names rather than a sentence somebody can reword.
 *
 * # The protocol
 *
 ...
 *
 * ```text
 * RANVIER_ERR_TIMEOUT: the operation ran out of time
 * ```
 *
...
export class AbiError extends Error {
  /**
   * The constant's own name — `RANVIER_ERR_TIMEOUT`, and so on.
   *
...
export interface ErrorsOptions {
  /** The prefix every constant of the package begins with, such as `RANVIER`. */
